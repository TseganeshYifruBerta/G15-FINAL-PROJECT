...
//   return (
//     <div className="mx-36 relative overflow-x-auto border border-gray-200 shadow-md sm:rounded-lg">
//     <table className="w-full align-center justify-center text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
//         <thead className="text-l text-black uppercase bg-primary dark:bg-primary dark:text-gray-400">
//             <tr>
//                 <th scope="col" className="px-6 py-3 border-r border-gray-300">
//                     Title
//                 </th>
