    ...
    >
      <div className="min-h-screen bg-white  flex items-center justify-center h-screen ">
          <div className="w-1/2 h-full bg-white">
             ...
             <p className="text-5xl font-semibold mb-14 ml-16"><span className = "text-[#7983FB]">BYTE</span> - MENTOR</p>
             
             <Image src="/signup.jpg" alt="JPG Image" width={400} height={400}className="ml-16 mb-4"
    />
          </div>
          ...
          <div className="absolute flex justify-between">
            <div className="bg-white rounded-lg p-8 shadow-md ml-20 w-[18rem] max-w-[18rem]">
              ...
              <h2 className="block items-center justify-between p-3 text-2xl font-semibold text-bold">Create Account</h2>
