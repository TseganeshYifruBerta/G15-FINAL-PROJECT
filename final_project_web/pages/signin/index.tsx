       ...
       <div className="min-h-screen bg-white  flex items-center justify-center h-screen">
         ...
         <div className="absolute flex justify-between">
           <div className="bg-white rounded-lg p-8 shadow-md ml-20 w-[18rem] max-w-[18rem]">
             ...
             <h2 className="block items-center justify-between p-3 text-2xl font-semibold text-bold text-center">
                Login
             </h2>
             ...
             <p className="mt-1 text-xs font-bold text-gray-600">
               ...
               <Link href={"/signup"}>
                 <button className="text-blue-500 font-bold">register</button>
               </Link>
             </p>
           </div>
         </div>
