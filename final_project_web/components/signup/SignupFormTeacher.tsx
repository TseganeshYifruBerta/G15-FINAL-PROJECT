  ...
  const renderTextAreaField = ({
    ...
    <div>
      ...
      <div className="relative">
        ...
        />
        {touched && error && <span className="text-red-500 text-xs absolute -bottom-4 left-0 right-0">{error}</span>}
      </div>
    </div>
  );
...
const SignupFormTeacher: React.FC<InjectedFormProps<FormValues>> = ({ handleSubmit }) => {
  ...
  return (
    ...
    <div className="mb-4">
             <label htmlFor="name" className="flex text-gray-600 text-xs"> <BiSolidUserRectangle className = "mr-2"/>
               User Name
             </label>
             <Field
               type="text"
