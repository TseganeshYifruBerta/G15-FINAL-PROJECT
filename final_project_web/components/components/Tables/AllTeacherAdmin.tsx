...
import { deleteUser,updateTeacher,Teacher,fetchAllTeachers } from '@/store/admin/get-all-teachers';
...
const filteredTeachers = teachers.filter(teacher =>
  ...
  (teacher.SectionsOfUser?.some(section => (section.section?.toLowerCase() || '').includes(searchQuery.toLowerCase())))
);
    ...
    <>
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-8 rounded-xl shadow-lg relative">  {/* Added relative positioning here */}
                ...
                <h3 className="text-lg mt-4 font-bold mb-4">Teacher Activated Successfully</h3>
...
<UploadPopup onUploadSuccess={getTeachers} />
