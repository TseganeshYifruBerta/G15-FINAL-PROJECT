...
interface AllQuestionsProps {
  examQueationsTakenByStudent: any[],
  studentId: string,
  examId: string

}
const AllExamQuestionsAnsweredByStudent: React.FC<AllQuestionsProps> = ({
  examQueationsTakenByStudent,
  studentId,
  examId
  ...
  const modifiedData = examQueationsTakenByStudent?.map((question: any) => {
...
export default AllExamQuestionsAnsweredByStudent;
