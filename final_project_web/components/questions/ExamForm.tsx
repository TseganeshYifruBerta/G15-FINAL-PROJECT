  ...
  return (
    <div>
      <div className="container w-5/6 pt-10 px-2 mx-auto font-bold text-2xl text-primary pl-4">
        <div>Create New Exam Question</div>
      </div>
            ...
            <div className="step bg-primary bg-opacity-10 px-6 pt-4 rounded-lg pb-10">
              ...
              <div className="mb-4">
                ...
                <button
                  ...
                  className="w-1/4 rounded-lg border-primary bg-white font-semibold text-primary border-2 px-4 py-2 mb-4"
                >
                  + Add Solution
                </button>
              </div>
            ...
            <div className="step bg-primary bg-opacity-10 px-6 pt-4 rounded-lg pb-10">
              ...
              <div className="mb-4">
                ...
                {solutions.map((sol, index) => (
                  <div key={index}>
                    <p>
                      <strong>Solution {index + 1}:</strong> {sol}
                    </p>
                  </div>
                ))}
              </div>
