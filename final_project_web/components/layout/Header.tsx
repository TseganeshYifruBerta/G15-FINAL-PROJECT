...
import ButtonOutline from "@/components/misc/ButtonOutline"; // Assuming ButtonOutline is already a TypeScript componen
import LogoVPN from "@/public/assets/Logo.svg"; // Make sure SVG loading is correctly set up in your TS config
    ...
    <>
      <header className={"fixed top-0 w-full z-30 bg-white transition-all " + (scrollActive ? "shadow-md pt-0" : "pt-4")}>
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-6 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <p className="text-lg font-bold">ሁሉ <span className="text-[#7983FB]">Code</span> </p>
          </div>
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
            <Link href="/" className="text-black-600 mx-2 sm:mx-4 capitalize tracking-wide hover:text-[#7983FB] transition-all">
